...
2. In the [Github repository settings](https://github.com/mariushelf/advent_of_code_2024/settings/environments),
   create a new environment named `production`. If you are the only
   contributor, you can leave all settings at the default.
3. Under [Secrets -> actions](https://github.com/mariushelf/advent_of_code_2024/settings/secrets/actions),
...
3. create a matching tag on your local machine and push it to the
   ...
   git push --tags
   ```
4. In [Github actions](https://github.com/mariushelf/advent_of_code_2024/actions)
   make sure that the test workflow succeeds.
5. In the Github [release tab](https://github.com/mariushelf/advent_of_code_2024/releases)
   ...
   [PyPI](https://pypi.org/project/advent_of_code_2024/).
...
`pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ advent_of_code_2024`
